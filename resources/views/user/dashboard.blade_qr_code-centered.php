<x-app-layout>
                ...
                <div class="space-y-4">
                        ...
                        <div class="flex items-start space-x-4">
                            <div class="flex-shrink-0">
                                <div
                                    ...
                                    <span class="text-xs text-indigo-600">DES</span>
                                </div>
                            </div>
                    ...
                    <div class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                        <div class="flex items-start space-x-4">
                            <div class="flex-shrink-0">
                                <div
                                    class="w-16 h-16 bg-green-100 rounded-lg flex flex-col items-center justify-center">
                                    <span class="text-2xl font-bold text-green-600">26</span>
                                    <span class="text-xs text-green-600">DES</span>
                                </div>
                            </div>
                            <div class="flex-1 min-w-0">
                    ...
                    <div class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                        <div class="flex items-start space-x-4">
                            <div class="flex-shrink-0">
                                <div
                                    class="w-16 h-16 bg-purple-100 rounded-lg flex flex-col items-center justify-center">
                                    <span class="text-2xl font-bold text-purple-600">28</span>
                                    <span class="text-xs text-purple-600">DES</span>
                                </div>
                            </div>
                            <div class="flex-1 min-w-0">
    ...
    <div class="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg z-50">
        <div class="flex items-center relative px-4 h-20">
            <!-- Home - Aligned Left -->
            <a href="#" class="flex flex-col items-center justify-center py-2 absolute left-8">
